    ...
    def test_incoming_features(self):
        ...
        self.assertJobResult(
            ...
            JobResult(
                ...
                data={
                    "2a171168ba538346aedca03c7871a195358d5d043eac7f6bfbab5bc520243c44": b'// plugin: Yara-0, namespace_identifier: exploits.check_filename.test_filename\nrule test_filename\n{\ncondition:\n    filename startswith "test.exe"\n}\n',
                    "47b07e41347363068c32451d938af21f1dd4ac2113ba5e1d8b97eba81c488be9": b'// plugin: Yara-0, namespace_identifier: exploits.check_filename.test_filepath\nrule test_filepath\n{\ncondition:\n    filepath startswith "/blah/"\n}\n',
                    "493580d9da173345d8a93d1780eb463a1315c57fe4d642e72e5576c460a2d7d0": b'// plugin: Yara-0, namespace_identifier: exploits.check_filename.test_extension\nrule test_extension\n{\ncondition:\n    extension startswith "exe"\n}\n',
                },
            ),
            inspect_data=True,
        )
